        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" name="kdplg" id="kdplg" class="form-control form-control-sm" value="<?= $kdplg; ?>">
                </div>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label for="">Nama pelanggan</label>
                    <input type="text" name="namaplg" id="namaplg" class="form-control form-control-sm" required value="<?= $namaplg; ?>">
                </div>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label for="">Alamat</label>
                    <input type="text" name="alamatplg" id="alamatplg" class="form-control form-control-sm" required value="<?= $alamatplg; ?>">
                </div>
            </div>
            <div class="modal-body">
                <div class="form-group">
